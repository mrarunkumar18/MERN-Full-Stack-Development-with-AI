# Project Instructions & Memory: MERN Full Stack Development with AI
...
### General
- **Indentation:** 2 spaces for all file types (HTML, CSS, JS).
- **File Naming:** `kebab-case` or `snake_case`. No spaces.
- **Tone:** Professional, direct, and concise technical communication.

### HTML/CSS
- **HTML:** Semantic HTML5 elements; responsive meta tags in all `index.html`.
- **CSS:** Prefer external `style.css`. Use Bootstrap 5 for responsive layouts. Grid/Flexbox for modern designs.

### JavaScript
- **Syntax:** Modern ES6+ (`const`/`let`, arrow functions, template literals).
- **Naming:** Descriptive variable and function names.
- **Logic:** Concise comments for complex logic.
